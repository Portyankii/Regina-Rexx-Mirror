 ...
 * Contributors:
 *
 * $Header: /opt/cvs/Regina/regutil/regfilesys.c,v 1.22 2023/05/25 22:14:31 mark Exp $
 */
#ifdef __EMX__
...
rxfunc(syssearchpath)
{
   ...
   const char delim[] = ":", pathpat[] = "%s/%s";
#endif
   char *pathseg, *pseg, *rpath, *path, *pathname, *filename, *env=NULL;
   int len;
